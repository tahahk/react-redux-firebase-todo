    ...
    return (
      <div className="App">
        <header className="App-header">
          ...
          <h1 className="App-title">Todo Using React and bootstrap</h1>
        </header><hr /><hr />
        <br /><br />
        <div className="input-width">
          ...
          <div className="input-group">
            <input type="text" className="form-control" placeholder="Please add todo..."  aria-describedby="basic-addon2" value={this.state.inputValue} onChange={this.formHandler} />
